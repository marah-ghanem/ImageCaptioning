...
from_disk = pickle.load(open('D://Projects//EyeSpeak//ImageCaptioning//FLASK//tv_layer.pkl', "rb"))
...
caption_model.load_weights('D://Projects//EyeSpeak//ImageCaptioning//FLASK//Image_Captioning_Weights_f.h5')
