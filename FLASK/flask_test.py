...
from_disk = pickle.load(open('D://Projects//EyeSpeak//EyeSpeak//FLASK//tv_layer.pkl', "rb"))
...
caption_model.load_weights('D://Projects//EyeSpeak//EyeSpeak//FLASK//Image_Captioning_Weights_f.h5')
